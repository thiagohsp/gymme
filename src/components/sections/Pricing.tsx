  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <GridItem>
            <Box bg={"rgba(19, 19, 22, 0.05)"} boxShadow={"dark-lg"} py={16} px={12}>
              <Center h="100%" >
                <VStack spacing={16}>
                  <Badge type="dark" >Basic</Badge>
          ...
          <GridItem>
            <Box bg={"neutral.500"} color={"white"} boxShadow={"dark-lg"} py={16} px={12}>
              <Center h="100%" >
                <VStack spacing={14}>
                  <Badge type="light" >Premium</Badge>
